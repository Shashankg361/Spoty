...
export default  function Home() {
  ...
  return (
    ...
    >
      <h1 className="start-text text-3xl font-semibold">Wellcome to Spoty !!</h1>
      <Link className="m-5" href={'https://spoty-13.vercel.app/api/authLog'}><button className="start-btn border-2 border-white pr-6 pl-6 pt-2 pb-2 rounded-full bg-green-500 text-2xl">Get Started</button></Link>
      ...
      <div>
        ...
        : <h1 className="text-xl m-3 font-semibold">Currently No song is being played !</h1>)}
      </div>
      {
        data && 
