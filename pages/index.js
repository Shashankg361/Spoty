...
export default  function Home() {
  ...
  return (
    ...
    >
      ...
      <Link className="m-5" href={'https://spoty-blush.vercel.app/api/authLog'}><button className=" border-2 border-white pr-6 pl-6 pt-2 pb-2 rounded-full bg-green-500 text-2xl">Get Started</button></Link>
