...
export default function LikedSong({accessToken}){
    ...
    return(
        <>  
            <div className="flex flex-col m-2 items-center">
                <button className=" border-2 border-white pr-6 pl-6 pt-2 pb-2 rounded-full mb-2" onClick={getData}>Get LikedSongs</button>
            {data && 
